      ...
      {showPlane && (
        <div className="animate-plane fixed left-0 top-0 z-50">
          <div className="relative h-[180px] w-[900px]">
            ...
            <div className="absolute left-[285px] top-[72px] z-20 w-[380px] rotate-[-3deg] rounded-full border-4 border-white bg-pink-500/90 px-6 py-3 text-center text-xl font-black text-white shadow-2xl">
              {message || "Thank you!"}
            </div>
