      ...
      {resetDialogOpen && (
        ...
        >
          <div
            role="dialog"
            aria-modal="true"
            aria-labelledby="reset-room-light-title"
            aria-describedby="reset-room-light-description"
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2
                  id="reset-room-light-title"
                  className="text-xl font-black text-white"
                >
                  Reset Room Light Settings?
                </h2>

                <p
                  id="reset-room-light-description"
                  className="mt-2 text-sm leading-6 text-zinc-400"
                >
                  This will restore all lighting
                  settings, colors, presets,
                  placement and effects to their
                  default values.
                </p>
              </div>
            </div>
