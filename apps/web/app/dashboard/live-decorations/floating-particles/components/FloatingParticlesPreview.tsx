      ...
      <div className="xl:sticky xl:top-4 xl:self-start">
        <Card className="overflow-hidden">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-zinc-400">
                Preview the current particle effect.
              </p>
            </div>
          ...
          >
            ...
            <FloatingParticles settings={settings} />
      ...
      {resetDialogOpen && (
        ...
        >
          <div
            role="dialog"
            aria-modal="true"
            aria-labelledby="reset-floating-particles-title"
            aria-describedby="reset-floating-particles-description"
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2
                  id="reset-floating-particles-title"
                  className="text-xl font-black text-white"
                >
                  Reset Floating Particles?
                </h2>

                <p
                  id="reset-floating-particles-description"
                  className="mt-2 text-sm leading-6 text-zinc-400"
                >
                  This will restore the particle type,
                  colors, amount, size, speed and motion
